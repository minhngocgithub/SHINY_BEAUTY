...
<script setup>
import OveralRating from '../reviews/rating/OveralRating.vue'
import CommentContent from '../reviews/comment/CommentContent.vue'
import LazyImg from '../atoms/LazyImg.vue'
import Abutton from '../atoms/Abutton.vue'
import { ref } from 'vue'
import ReviewStar from '../reviews/rating/ReviewStar.vue'
